...
normalized_data <- scale(airline[ ,2:12]) #excluding the ID column before normalizing
...
#from screen plot first elbow bend is at 4 so we can say that we have to go with 4 no. of clusters
